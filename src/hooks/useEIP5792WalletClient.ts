...
type EIP5792WalletClient<chain extends Chain | undefined = Chain | undefined,
account extends Account | undefined = Account | undefined> = WalletClient<Transport, chain, account> & WalletActionsEip5792<chain, account>;
